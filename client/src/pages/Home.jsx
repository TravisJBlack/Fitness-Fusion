...
import { QUERY_CLASS, QUERY_USER } from '../utils/queries'; // Assuming QUERY_USER is needed to fetch user data
...
const Home = () => {
  ...
  const { loading: userLoading, data: userData } = useQuery(QUERY_USER); // Add user query
