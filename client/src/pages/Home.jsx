...
import {
  Stack, VStack, CardBody, CardFooter, Popover,
  PopoverTrigger,
  PopoverContent,
  PopoverHeader,
  PopoverBody,
  ...
  PopoverArrow,
  PopoverCloseButton,
  PopoverAnchor, Button, Heading, Text, Card, Image as ChakraLink, Img
                  ...
                  <CardFooter>
                    {Auth.loggedIn() ?
                      <Popover>
                        ...
                        {userClass.includes(course._id) ? (<PopoverContent>
                         
                          <PopoverArrow />
                          <PopoverCloseButton />
                          <PopoverHeader>Already Enrolled!!</PopoverHeader>
                          <PopoverBody>Look forward to seeing you in class!!!</PopoverBody>
                        </PopoverContent>)
                          : (
                            <PopoverContent>
                              <PopoverArrow />
